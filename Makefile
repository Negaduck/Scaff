...
$(OBJDIR_DEBUG)/modul_scaff.o: modul_scaff.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c modul_scaff.cpp -o $(OBJDIR_DEBUG)/modul_scaff.o

$(OBJDIR_DEBUG)/scaff.o: scaff.cpp
	$(CXX) $(CFLAGS_DEBUG) $(INC_DEBUG) -c scaff.cpp -o $(OBJDIR_DEBUG)/scaff.o
...
$(OBJDIR_RELEASE)/modul_scaff.o: modul_scaff.cpp
	$(CXX) $(CFLAGS_RELEASE) $(INC_RELEASE) -c modul_scaff.cpp -o $(OBJDIR_RELEASE)/modul_scaff.o

$(OBJDIR_RELEASE)/scaff.o: scaff.cpp
	$(CXX) $(CFLAGS_RELEASE) $(INC_RELEASE) -c scaff.cpp -o $(OBJDIR_RELEASE)/scaff.o
